...
- **Business Model (Three-Tier)**:
  ...
  - **Tier 3 — Premium Suite**: 120,000 PHP One-Time Setup (Includes full integration, unlimited agents, and 1-year money-back guarantee).
...
- **Slide 3: The Investment**: 120,000 PHP pricing, 🛡️ 1-Year Full Refund Guarantee, and Renewal Policy.
...
1. [x] **Premium Suite Deck**: Integrated 120k PHP investment slide into Admin Pitch Mode.
...
- **2026-04-02 (V20.0)**: **PREMIUM SUITE DEPLOYED**.
  - **Investment Deck Updated**: Added 120,000 PHP pricing model and 1-year refund guarantee to Pitch Mode.
  - **Navigation UX Upgrade**: Added explicit side-navigation arrows to the Admin overlay for smoother dealer demos.
  - **Pricing Realignment**: Finalized tiers for Agent ($99/mo) and Dealer (120k PHP one-time).
